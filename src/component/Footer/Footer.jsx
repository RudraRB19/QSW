  ...
  return (
    <>
      <footer className="bg-white border-y">
            <div className="mx-auto w-full max-w-screen-xl p-3 py-2 lg:py-2">
                <div className="md:flex md:justify-between">
                    <div className="mb-0 md:mb-0">
                        <Link to="/" className="flex items-center">
                            <img
                                src="src\assets\logo.svg"
                                className="mr-1 h-28 w-72"
                                alt="Logo"
                            />
                        </Link>
                    </div>
                    <div className="grid grid-cols-2 py-6 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
