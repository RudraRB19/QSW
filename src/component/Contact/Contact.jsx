            ...
            <div className="max-w-6xl mx-auto sm:px-6 lg:px-">
                <div className="mt-6 overflow-hidden">
                    <div className=" grid grid-cols-1 md:grid-cols-2">
                        <div className="p-6 mr-2 bg-gray-100 sm:rounded-l-xl">
                        ...
                        <form className="p-6 flex flex-col border border-solid">
                            <div className='flex flex-col text-center'>
                                <h2 className='font-semibold text-2xl py-2 text-gray-700'>Enquiry Form</h2>
                            </div>
